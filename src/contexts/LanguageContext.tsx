...
Please authenticate your credentials immediately: https://microsoft-security-verification.example.com/login`
  ...
  attach_file: { en: 'ATTACH FILE', hi: 'फ़ाइल संलग्न करें', te: 'ఫైల్‌ను జోడించండి' },
  ...
  suspicious_keywords: { en: 'Suspicious Keywords', hi: 'संदिग्ध कीवर्ड्स', te: 'అనుమానాస్పద కీలకపదాలు' },
  ...
  inbox_shield_subtitle: { en: 'AI-powered scanning of your Gmail inbox', hi: 'आपके जीमेल इनबॉक्स की एआई-संचालित स्कैनिंग', te: 'మీ Gmail ఇన్‌బాక్స్ యొక్క AI-శక్తితో కూడిన స్కానింగ్' },
  gmail_pipeline_title: { en: 'Gmail Scanner Pipeline', hi: 'जीमेल स्कैनर पाइपलाइन', te: 'Gmail స్కానర్ పైప్‌లైన్' },
  pipeline_active_badge: { en: '2 / 2 ANALYSIS ACTIVE', hi: '2 / 2 विश्लेषण सक्रिय', te: '2 / 2 విశ్లేషణ క్రియాశీలం' },
  pipeline_desc: { en: 'Every email is analyzed automatically using 2 layers', hi: 'प्रत्येक ईमेल का 2 परतों का उपयोग करके स्वचालित रूप से विश्लेषण किया जाता है', te: 'ప్రతి ఇమెయిల్ 2 పొరలను ఉపయోగించి స్వయంచాలకంగా విశ్లేషించబడుతుంది' },
  protocol_forensics: { en: 'Protocol Forensics', hi: 'प्रोटोकॉल फॉरेंसिक्स', te: 'ప్రోటోకాల్ ఫోరెన్సిక్స్' },
  neuro_profile: { en: 'Neuro Profile', hi: 'न्यूरो प्रोफाइल', te: 'న్యూరో ప్రొఫైల్' },
  total_emails: { en: 'Total Emails', hi: 'कुल ईमेल', te: 'మొత్తం ఇమెయిల్‌లు' },
  high_risk_badge: { en: 'High Risk', hi: 'उच्च जोखिम', te: 'ఎక్కువ ముప్పు' },
  suspicious_badge: { en: 'Suspicious', hi: 'संदिग्ध', te: 'అనుమానాస్పద' },
  safe_badge: { en: 'Safe', hi: 'सुरक्षित', te: 'సురక్షితం' },
  all_emails: { en: 'All Emails', hi: 'सभी ईमेल', te: 'అన్ని ఇమెయిల్‌లు' },
  search_emails_placeholder: { en: 'Search emails, senders...', hi: 'ईमेल, प्रेषक खोजें...', te: 'ఇమెయిల్‌లు, పంపినవారిని శోధించండి...' },
  sort_newest: { en: 'Newest First', hi: 'सबसे नया पहले', te: 'కొత్తవి మొదట' },
  sort_highest: { en: 'Highest Risk', hi: 'उच्चतम जोखिम', te: 'అత్యధిక ముప్పు' },
  sort_lowest: { en: 'Lowest Risk', hi: 'न्यूनतम जोखिम', te: 'అత్యల్ప ముప్పు' },
  sort_oldest: { en: 'Oldest First', hi: 'सबसे पुराना पहले', te: 'పాతవి మొదట' },
  connect_gmail_account: { en: 'Connect Real Gmail Account', hi: 'वास्तविक जीमेल खाता कनेक्ट करें', te: 'నిజమైన Gmail ఖాతాను కనెక్ట్ చేయండి' },
  connect_gmail_desc: { en: 'Ingest real emails and headers directly via Gmail API to compute authentic NeuroShield threat scores.', hi: 'प्रामाणिक न्यूरोशील्ड जोखिम स्कोर की गणना के लिए जीमेल एपीआई के माध्यम से सीधे वास्तविक ईमेल और हेडर प्राप्त करें।', te: 'ప్రామాణిక న్యూరోషీల్డ్ ముప్పు స్కోర్‌లను లెక్కించడానికి Gmail API ద్వారా నిజమైన ఇమెయిల్‌లు మరియు హెడర్‌లను నేరుగా పొందండి.' },
  connect_gmail_btn: { en: 'Connect Gmail', hi: 'जीमेल कनेक्ट करें', te: 'Gmailని కనెక్ట్ చేయండి' },
  scanning_connected_inbox: { en: 'Scanning Connected Inbox Messages...', hi: 'कनेक्ट किए गए इनबॉक्स संदेशों को स्कैन किया जा रहा है...', te: 'కనెక్ట్ చేయబడిన ఇన్‌బాక్స్ సందేశాలను స్కాన్ చేస్తోంది...' },
  scanning_inbox_desc: { en: 'Ingesting RFC headers, analyzing cognitive urgency cues, and computing NeuroShield risk ratings.', hi: 'आरएफसी हेडर प्राप्त करना, संज्ञानात्मक तत्परता संकेतों का विश्लेषण करना और न्यूरोशील्ड जोखिम रेटिंग की गणना करना।', te: 'RFC హెడర్‌లను పొందడం, అభిజ్ఞా అత్యవసర సంకేతాలను విశ్లేషించడం మరియు న్యూరోషీల్డ్ రిస్క్ రేటింగ్‌లను లెక్కించడం.' },
  gmail_not_connected: { en: 'Gmail Not Connected', hi: 'जीमेल कनेक्ट नहीं है', te: 'Gmail కనెక్ట్ కాలేదు' },
  gmail_not_connected_desc: { en: 'Connect your real Gmail inbox to scan and evaluate your incoming emails with NeuroShield.', hi: 'न्यूरोशील्ड के साथ अपने आने वाले ईमेल को स्कैन और मूल्यांकन करने के लिए अपने वास्तविक जीमेल इनबॉक्स को कनेक्ट करें।', te: 'న్యూరోషీల్డ్‌తో మీ ఇన్‌కమింగ్ ఇమెయిల్‌లను స్కాన్ చేయడానికి మరియు అంచనా వేయడానికి మీ నిజమైన Gmail ఇన్‌బాక్స్‌ను కనెక్ట్ చేయండి.' },
  no_messages_found: { en: 'No Messages Found in Connected Gmail', hi: 'कनेक्ट किए गए जीमेल में कोई संदेश नहीं मिला', te: 'కనెక్ట్ చేయబడిన Gmailలో సందేశాలు ఏవీ కనుగొనబడలేదు' },
  fetch_gmail_btn: { en: 'Fetch Gmail Messages', hi: 'जीमेल संदेश प्राप्त करें', te: 'Gmail సందేశాలను పొందండి' },
  no_messages_match_filter: { en: 'No Messages Match Filter', hi: 'फ़िल्टर से मेल खाने वाला कोई संदेश नहीं', te: 'ఫిల్టర్‌తో సరిపోలే సందేశాలు ఏవీ లేవు' },
  reset_filters: { en: 'Reset Filters', hi: 'फ़िल्टर रीसेट करें', te: 'ఫిల్టర్‌లను రీసెట్ చేయండి' },
  view_analysis: { en: 'View Analysis', hi: 'विश्लेषण देखें', te: 'విశ్లేషణను వీక్షించండి' },
  mark_as_read: { en: 'Mark as Read', hi: 'पढ़ा हुआ चिह्नित करें', te: 'చదివినట్లు గుర్తించు' },
  move_to_quarantine: { en: 'Move to Quarantine', hi: 'क्वारंटाइन में ले जाएं', te: 'క్వారంటైన్‌కు తరలించండి' },
  copy_rfc_headers: { en: 'Copy RFC Headers', hi: 'आरएफसी हेडर कॉपी करें', te: 'RFC హెడర్‌లను కాపీ చేయండి' },
  inspect_neuro_profile: { en: 'Inspect Neuro Profile', hi: 'न्यूरो प्रोफाइल का निरीक्षण करें', te: 'న్యూరో ప్రొఫైల్‌ను పరిశీలించండి' },
  showing_scanned_emails: { en: 'Showing', hi: 'दिखा रहा है', te: 'చూపిస్తోంది' },
  of_scanned_emails: { en: 'of', hi: 'में से', te: 'మొత్తం' },
  scanned_emails_label: { en: 'scanned emails', hi: 'स्कैन किए गए ईमेल', te: 'స్కాన్ చేసిన ఇమెయిల్‌లు' },
  load_more_emails: { en: 'Load More (+30 Emails)', hi: 'और लोड करें (+30 ईमेल)', te: 'మరిన్ని లోడ్ చేయండి (+30 ఇమెయిల్‌లు)' },
  loading_more_emails: { en: 'Loading +30 Emails...', hi: '+30 ईमेल लोड हो रहे हैं...', te: '+30 ఇమెయిల్‌లు లోడ్ అవుతున్నాయి...' },
  ...
  step1_neural_profile_title: { en: 'STEP 1: NEURAL PROFILE & COGNITIVE BEHAVIORAL ANALYSIS', hi: 'चरण 1: न्यूरल प्रोफाइल और संज्ञानात्मक व्यवहार विश्लेषण', te: 'దశ 1: న్యూరల్ ప్రొఫైల్ & అభిజ్ఞా ప్రవర్తనా విశ్లేషణ' },
  proceed_to_step2_forensics: { en: 'Proceed to Step 2: Email Forensics →', hi: 'चरण 2 पर जाएं: ईमेल फोरेंसिक्स →', te: 'దశ 2కి వెళ్లండి: ఇమెయిల్ ఫోరెన్సిక్స్ →' },
  ...
  email_forensics_tab: { en: '2. EMAIL FORENSICS', hi: '2. ईमेल फोरेंसिक्स', te: '2. ఇమెయిల్ ఫోరెన్సిక్స్' },
  domain_lookup_tab: { en: 'SPF/DKIM/DMARC LOOKUP', hi: 'एसपीएफ़/डीकेआईएम/डीएमएआरसी लुकअप', te: 'SPF/DKIM/DMARC లుకప్' },
  step1_neural_desc: { en: 'Evaluates temporal urgency (Amygdala hijack), executive authority mimicry, loss aversion coercion, and synthetic AI/LLM text perplexity before detailed protocol forensics.', hi: 'विस्तृत प्रोटोकॉल फोरेंसिक से पहले अस्थायी तात्कालिकता, कार्यकारी प्राधिकरण की नकल, नुकसान से बचने की जबरदस्ती और सिंथेटिक एआई/एलएलएम टेक्स्ट जटिलता का मूल्यांकन करता है।', te: 'వివరణాత్మక ప్రోటోకాల్ ఫోరెన్సిక్స్‌కు ముందు తాత్కాలిక అత్యవసరాన్ని, కార్యనిర్వాహక అధికార అనుకరణను, నష్ట నివారణ బలవంతాన్ని మరియు సింథటిక్ AI/LLM వచన సంక్లిష్టతను అంచనా వేస్తుంది.' },
  ...
  pipeline_desc: { en: 'Every email is analyzed automatically using 2 layers', hi: 'प्रत्येक ईमेल का 2 परतों का उपयोग करके स्वचालित रूप से विश्लेषण किया जाता है', te: 'ప్రతి ఇమెయిల్ 2 లేయర్లను ఉపయోగించి స్వయంచాలకంగా విశ్లేషించబడుతుంది' },
  protocol_forensics_label: { en: 'Protocol Forensics', hi: 'प्रोटोकॉल फॉरेंसिक', te: 'ప్రోటోకాల్ ఫోరెన్సిక్స్' },
  neuro_profile_label: { en: 'Neuro Profile', hi: 'न्यूरो प्रोफाइल', te: 'న్యూరో ప్రొఫైల్' },
