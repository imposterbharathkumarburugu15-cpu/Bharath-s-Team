...
Please authenticate your credentials immediately: https://microsoft-security-verification.example.com/login`
  ...
  step1_neural_profile_title: { en: '1. NEURO PROFILE (COGNITIVE & PSYCHOLOGICAL LAYER)', hi: '1. न्यूरो प्रोफाइल (संज्ञानात्मक और मनोवैज्ञानिक परत)', te: '1. న్యూరో ప్రొఫైల్ (అభిజ్ఞా & మానసిక పొర)' },
  ...
  neural_profile_tab: { en: '1. NEURO PROFILE', hi: '1. न्यूरो प्रोफाइल', te: '1. న్యూరో ప్రొఫైల్' },
  ...
  pipeline_desc: { en: 'Every email is analyzed automatically: 1. Neuro Profile & 2. Email Forensic Layer', hi: 'प्रत्येक ईमेल का विश्लेषण: 1. न्यूरो प्रोफाइल और 2. ईमेल फोरेंसिक लेयर', te: 'ప్రతి ఇమెయిల్ విశ్లేషణ: 1. న్యూరో ప్రొఫైల్ & 2. ఇమెయిల్ ఫోరెన్సిక్ లేయర్' },
  protocol_forensics_label: { en: '2. Email Forensic Layer', hi: '2. ईमेल फोरेंसिक लेयर', te: '2. ఇమెయిల్ ఫోరెన్సిక్ లేయర్' },
  neuro_profile_label: { en: '1. Neuro Profile', hi: '1. न्यूरो प्रोफाइल', te: '1. న్యూరో ప్రొఫైల్' },
  ...
  inspect_neuro_profile: { en: 'Inspect 1. Neuro Profile', hi: '1. न्यूरो प्रोफाइल का निरीक्षण करें', te: '1. న్యూరో ప్రొఫైల్‌ను పరిశీలించండి' },
