...
export const navItems: NavItem[] = [
  // OPERATIONS
  { name: 'Start here', id: 'landing', icon: ArrowRight, category: 'CORE', description: 'Connect Gmail and begin reviewing email' },
  ...
  { name: 'phishing', id: 'phishing', icon: Mail, category: 'CORE', badge: 'GMAIL', shortcut: '2', description: 'Gmail read-only inbox, forensic evidence and protection decisions' },
...
export function Layout({ 
  ...
  return (
    <div className="flex h-screen w-full bg-[#0a0e0b] text-white overflow-hidden relative selection:bg-cyber-blue selection:text-black font-sans print:h-auto print:overflow-visible print:bg-[#0a0e0b]">
      ...
      <aside 
        className={cn(
          "hidden md:flex h-full flex-shrink-0 border-r border-cyber-border/40 bg-[#0e1511]/95 backdrop-blur-2xl z-30 flex-col py-4 box-border shadow-[10px_0_30px_rgba(0,0,0,0.6)] transition-all duration-300 relative print:hidden",
      ...
      >
        ...
        {!isSidebarCollapsed && (
          <button
            ...
            className="w-full mb-5 px-3 py-2 rounded-xl bg-[#0f1612] border border-cyber-border/60 hover:border-cyber-blue/50 text-gray-400 hover:text-white flex items-center justify-between transition-all group text-xs font-mono"
          >
              ...
              return (
                ...
                >
                  ...
                  {isSidebarCollapsed && hoveredNavId === item.id && (
                    <div className="fixed left-20 z-50 ml-2 px-3 py-1.5 bg-[#0f1612] border border-cyber-blue/40 rounded-xl shadow-2xl text-xs font-mono whitespace-nowrap animate-in fade-in zoom-in-95 pointer-events-none">
                      <div className="flex items-center gap-2">
        ...
        {!isSidebarCollapsed ? (
          <div className="mt-3 space-y-3 w-full">
            ...
            <div 
              ...
              className="p-3 bg-[#101712] rounded-xl border border-white/5 relative overflow-hidden group cursor-pointer hover:border-cyan-500/30 transition-all"
            >
              <div className="flex items-start justify-between gap-2">
                <div className="flex items-center gap-2">
                  <div className="w-5 h-5 rounded-md flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4" viewBox="0 0 24 24">
                      <path fill="#61d58c" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
          ...
          <div 
            ...
            className={`mt-3 w-10 h-10 rounded-xl bg-[#0f1612] border border-cyber-border/50 flex items-center justify-center cursor-pointer relative group ${
      ...
      <div className="flex-1 flex flex-col z-10 h-full overflow-hidden relative min-w-0 print:h-auto print:overflow-visible">
        ...
        <header className="h-16 flex-shrink-0 border-b border-cyber-border/40 bg-[#0b100d]/90 backdrop-blur-xl flex items-center justify-between px-3 sm:px-6 z-20 shadow-md print:hidden">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <button
              onClick={() => setIsCommandPaletteOpen(true)}
              className="hidden sm:flex items-center gap-2.5 bg-[#0f1712] hover:bg-[#141d17] px-3 py-1.5 rounded-xl border border-cyber-border/60 hover:border-cyber-blue/50 text-gray-400 hover:text-white transition-all text-xs font-mono w-44 md:w-56 lg:w-64 justify-between cursor-pointer"
            >
              <div className="flex items-center gap-2 truncate">
            ...
            <div className="relative">
              ...
              {showLangDropdown && (
                <div className="absolute right-0 mt-2 w-44 bg-[#0f1612] border border-cyber-blue/40 rounded-2xl shadow-2xl overflow-hidden z-50 p-1.5 animate-in fade-in zoom-in-95">
            ...
            <div className="relative">
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-2 w-80 max-w-[90vw] bg-[#0f1612] border border-cyber-border/80 rounded-2xl shadow-2xl overflow-hidden z-50 animate-in fade-in zoom-in-95">
        ...
        {isCommandPaletteOpen && (
          <div className="fixed inset-0 z-[150] flex items-start justify-center pt-20 px-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-[#0f1612] border border-cyber-blue/50 rounded-2xl shadow-[0_0_50px_rgba(0,243,255,0.2)] overflow-hidden flex flex-col z-10"
            >
              {/* Search Input */}
              <div className="p-4 border-b border-cyber-border/60 flex items-center gap-3 bg-[#101813]">
              ...
              <div className="p-3 bg-[#0a100c] border-t border-white/5 flex items-center justify-between text-[11px] font-mono text-gray-400">
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-0 bottom-0 left-0 w-80 max-w-[85vw] bg-[#0b100d] border-r border-cyber-border/60 z-[100] flex flex-col p-5 shadow-2xl md:hidden"
            >
              {/* Drawer Header */}
      ...
      {/* ========================================================
         ...
         ======================================================== */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#0b100d]/95 backdrop-blur-2xl border-t border-cyber-border/60 px-2 py-1.5 shadow-[0_-10px_25px_rgba(0,0,0,0.8)] safe-bottom print:hidden">
      ...
      <AnimatePresence>
        {showCopilot && (
          <motion.div 
            ...
            className="fixed bottom-20 md:bottom-6 right-4 sm:right-6 w-[calc(100vw-2rem)] sm:w-[360px] z-[100] bg-[#0f1612] border border-cyber-blue/50 rounded-2xl flex flex-col shadow-2xl overflow-hidden"
          >
