    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-cyan-500/15 text-cyan-300 border border-cyan-500/40 hover:bg-cyan-500/25 hover:border-cyan-400 shadow-[0_0_15px_rgba(86,170,118,0.15)]": variant === "default",
            "bg-gradient-to-r from-cyan-500 via-sky-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-bold border border-cyan-300/60 shadow-[0_0_20px_rgba(86,170,118,0.35)]": variant === "cyber",
